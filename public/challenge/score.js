...
function modifyTables(selected_solver, selected_problem) {
    ...
    // Time steps
    var timestep = 1000;
    // XXX Commented it, because it is not finished yet
    //if (document.getElementById("timestep_all").checked) {
    //    timestep = 0;
    //}
    //if (document.getElementById("timestep_1sec").checked) {
    //    timestep = 1000;
    //}
    //if (document.getElementById("timestep_5sec").checked) {
    //    timestep = 5000;
    //}
    //else if (document.getElementById("timestep_1min").checked) {
    //    timestep = 60000;
    //}
