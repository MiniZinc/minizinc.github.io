...
These are the official rules for the MiniZinc Challenge 2022. Version 1.1.  
These rules were last updated on 6 May 2022.

### Solver Submission

The MiniZinc Challenge 2022 will test solvers on problems written in MiniZinc 2.6.3.
...
The results will be announced at [CP2022](https://cp2022.a4cp.org). Participants are encouraged to
...
FlatZinc solvers must accept the following [standard options](/doc-2.6.3/en/fzn-spec.html#command-line-interface-and-standard-options), and they must be included in the supported
`stdFlags` of the [solver configuration](/doc-2.6.3/en/fzn-spec.html#sec-cmdline-conffiles):
...
MiniZinc solvers must support the following [options](doc-2.6.3/en/command_line.html#options)
...
[FlatZinc 2.6.3 specification](https://www.minizinc.org/doc-2.6.3/en/fzn-spec.html#output).
...
[MiniZinc 2.6.3](../doc-2.6.3/en/MiniZinc%20Handbook.pdf).  
...
4.  Search annotations will be restricted to **bool_search**, **int_search**, **set_search** and
    ...
    *   search style
    ...
    [FlatZinc 2.6.3 specification](https://www.minizinc.org/doc-2.6.3/en/fzn-spec.html#search-annotations).
...
of only the global constraints included in the MiniZinc 2.6.3 library, as well as some (preferably 
