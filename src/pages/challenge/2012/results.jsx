      ...
      <main>
        <Container>
          <article className="prose prose-minizinc max-w-none py-6">
            <Scripts
              scripts={[
                '/challenge/2012/locations.js',
                '/challenge/2012/results.js',
                '/challenge/2012/score.js',
              ]}
              onReady={() => init()}
            />
            ...
            <p>The results for the MiniZinc Challenge 2012 were:</p>
            <Medals medals={medals[2012]} />
