...
export default function Page() {
  return (
    <>
      <Head>
        <title>MiniZinc - Challenge 2016 Rules</title>
      </Head>
      <Header />
      <main>
        <Container>
          <article className="prose prose-minizinc max-w-none py-6">
            <h2>MiniZinc Challenge 2016 -- Rules</h2>
            <Breadcrumbs
              className="not-prose"
              items={[
            ...
            />
            <p>
              These are the official rules for the MiniZinc Challenge 2016.
              Version 2.0.13. <br /> These rules were last updated on 19 May
              2016.
            </p>
            <h3>Entrants</h3>
            <p>
              The MiniZinc Challenge 2016 will test solvers on problems written
              in MiniZinc 2.0.13.
            ...
            <ol>
              ...
              <li>
                <p>
                  ...
                  <Link href="/challenge/2016">
                    MiniZinc Challenge 2016 website
                  </Link>
                  .
                </p>
              </li>
                  ...
                  <li>
                    <ul>
                      <li>
                        ...
                        handling FlatZinc version 2.0.13. If your FlatZinc
                        solver <strong>only</strong> handles XML-FlatZinc
                        ...
                        2.0.13 model instance to evaluate.{' '}
                      </li>
                      <li>
                        <b> MiniZinc Solver</b>
                        ...
                        names of a MiniZinc 2.0.13 model and data file,
            ...
            <p>
              ...
              <Link href="http://cp2016.a4cp.org">CP2016</Link>. Entrants are
              encouraged to physically attend CP2016, but are not required to in
            ...
            <li>
              ...
              <p>
                The problem format will be MiniZinc 2.0.13.
                  ...
                  <ul>
                    <li>
                      ...
                      <ul>
                        ...
                        <li>
                          anti_first_fail (variable with largest domain
                          size){' '}
                        </li>
                        <li>
              ...
              <p>
                During the MiniZinc Challenge 2016 all VMs will run on machines
                with the following specification:
              </p>
              <ul>
                <li>Operating System: Ubuntu 14.04.4 LTS </li>
                <li>Processor(s): i7 3770 @ 3.40GHz (8 logical cores) </li>
                <li>Memory: 16 Gb </li>
                <li>VirtualBox 5.0.20r106931 </li>
              </ul>
              <p>
                Except in the Parallel searchi, Local search, and Open class,
                only a single core of one processor will be used for each
                entrant.
              </p>
              <h3>Benchmark Selection</h3>
              <p>
                The benchmarks for MiniZinc Challenge 2016 (as well as for the
              ...
              <p>
                ...
                two MiniZinc 2.0.13 models, making use of only the global
                constraints included in the MiniZinc 2.0.13 library, as well as
              ...
              <p>
                Return to the{' '}
                <Link href="/challenge/2016">MiniZinc Challenge 2016</Link> home
                page.
              </p>
            </li>
          </article>
