...
export default function Page() {
  return (
    <>
      <Head>
        <title>MiniZinc - Challenge 2016</title>
      </Head>
      <Header />
      <main>
        <Container>
          <article className="prose prose-minizinc max-w-none py-6">
            <h2>MiniZinc Challenge 2016</h2>
            <Breadcrumbs
              className="not-prose"
              items={[['MiniZinc Challenge', '/challenge'], 'Challenge 2016']}
            />
            <h3>The Challenge</h3>
            <p>
            ...
            <ul>
              <li>
                <b>2016-09-05</b> Announcement of the results available{' '}
                <Link href="/challenge/2016/results">here</Link>.{' '}
              </li>
              ...
              <li>
                <b>2016-05-20</b> MiniZinc problem submission deadline was
                extended till 28 May 2016
              </li>
              <li>
                <b>2016-02-19</b> Initial{' '}
                <Link href="/challenge/2016/call_for_problems">
            ...
            <ul>
              <li>
                Registration opens: <strong>Closed</strong>.{' '}
              </li>
              <li>
              ...
              <li>
                ...
                <strong>Sat, 25 June 2016</strong>.{' '}
              </li>
              <li>
                Initial submission round ends:{' '}
                <strong>Sat, 16 July 2016</strong>.{' '}
              </li>
              <li>
                Final submissions: <strong>Sat, 30 July 2016</strong>.{' '}
              </li>
              <li>
                Announcement of results at{' '}
                <Link href="http://cp2016.a4cp.org">
                  <abbr>CP2016</abbr>
                </Link>
                : <strong>5 - 9 September 2016</strong>.{' '}
              </li>
            </ul>
            <h3>Registration</h3>
            <p>
            ...
            <p>
              ...
              <strong>Sun, 22 May 2016</strong>. The call for problem submission
              is available{' '}
              <Link href="/challenge/2016/call_for_problems">here</Link>. Please
              feel free to distribute it.
            </p>
            <h3>Rules</h3>
            <p>
              The rules for the MiniZinc Challenge 2016 are available{' '}
              <Link href="/challenge/2016/rules">here</Link>.<br /> If we need
            ...
            <h3>Feedback</h3>
            <p>
              This is the nineth time this challenge is run, and there are many
            ...
            <p>
              The <Link href="/challenge/2015">MiniZinc Challenge 2015</Link>{' '}
              webpage, include the results from the previous year.
            </p>
            <p>
              The <Link href="/challenge">MiniZinc Challenges 2008-2015</Link>{' '}
