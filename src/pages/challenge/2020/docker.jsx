...
export default function Page() {
  return (
    <>
      <Head>
        <title>MiniZinc - Challenge 2020 Docker Image Preparation</title>
      </Head>
      <Header />
      <main>
        <Container>
          <article className="prose prose-minizinc max-w-none py-6">
            <h2>Prepare a Docker image for the MiniZinc Challenge 2020</h2>
            <Breadcrumbs
              className="not-prose"
              items={[
            ...
            <p>
              ...
              for the MiniZinc Challenge 2020.
            </p>
            <p>
              Like last year, we provide a docker image{' '}
            ...
            <p>
              ...
              challenges, docker provides a number of advantages:
            </p>
            <ul>
              <li>No predefined disk space limitation.</li>
            ...
            <p>
              ...
              . Read through all instructions and requirements on the webpage
              before you start the installation. Follow the installation steps
              provided on that page. You can test your installation by executing
              following command.
            </p>
            <pre>
              <code>docker run hello-world</code>
            </pre>
            <h3 id="registration-to-docker-hub">
            ...
            <p>
              ...
              and is available at the repository <code>minizinc/mznc2020</code>{' '}
              with the current tag <code>latest</code>. Pull the repository via
              command line by this command.
            </p>
            <pre>
              <code>docker pull minizinc/mznc2020</code>
            </pre>
            <p>
              The image contains a minimal installation of Ubuntu 18.04 and
              MiniZinc 2.4.3, which is installed in the{' '}
              <code>/usr/local/bin</code> directory. In the MiniZinc directory{' '}
              <code>/minizinc</code>, there are the three shell scripts{' '}
              <code>mzn-exec-fd</code> (for the FD class),{' '}
              <code>mzn-exec-free</code> (for the FREE class), and{' '}
              <code>mzn-exec-par</code> (for the PAR class) (these are the same
              as in previous MiniZinc Challenges). If you sumit a MiniZinc
              solver then you need to modify them accordingly. If you submit a
              FlatZinc solver then you may need to add, modify, or remove
              parameters that are used for calling your FlatZinc solver. In the
              case of a FlatZinc solver, there must an executable at{' '}
            ...
            <h5 id="creation-of-a-dockerfile">
            ...
            <p>
              ...
              statement must be <code>FROM minizinc/mznc2020</code>.
            </p>
            <pre>
            ...
            <ol style={{ listStyleType: 'decimal' }}>
              <li>
                ...
                <pre>
                  <code>
                    docker run -it --name solver minizinc/mznc2020 /bin/bash
                  </code>
                </pre>
                <p>
