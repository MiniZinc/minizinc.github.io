...
- Running `minizinc` with the default solver (i.e. without the `--solver` option) must run your
  ...
  - If you have a <Link href={`/doc-${challenge.minizinc}/en/fzn-spec.html#solver-configuration-files`}>solver configuration file</Link>
...
It is recommended that you create a <Link href={`/doc-${challenge.minizinc}/en/fzn-spec.html#solver-configuration-files`}>solver configuration file</Link> for your solver,
and set it as the default solver using a <Link href={`/doc-${challenge.minizinc}/en/command_line.html#user-configuration-files`}>user configuration file</Link> (the details of how to do this are in the following section),
...
See the documentation <Link href={`/doc-${challenge.minizinc}/en/fzn-spec.html#sec-cmdline-conffiles`}>here</Link> for more information.
