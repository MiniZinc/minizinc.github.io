...
export default function Page() {
  return (
    <>
      <Head>
        <title>MiniZinc - Challenge 2019 Call for Problems</title>
      </Head>
      <Header />
      <main>
        <Container>
          <article className="prose prose-minizinc max-w-none py-6">
            {' '}
            <h2>Call for Problem Submission for the MiniZinc Challenge 2019</h2>
            <Breadcrumbs
              className="not-prose"
              items={[
            ...
            <p>
              ...
              Programming. The MiniZinc Challenge 2019 is seeking interesting
            ...
            <ul>
              <li>
                Send an email with the subject line “[MZNC19] benchmark” to
            ...
            <p>
              ...
              instances are particulary welcome. Models for the 2019 challenge
            ...
            <p>
              ...
              definitions provided in the MiniZinc 2.2 distribution. If you have
              an instance generator, we are more than happy to receive it.
              Please, follow the links below for submission instructions and
              requirements.
            </p>
            <p>
              <Link href="http://www.minizinc.org/challenge/2019">
                www.minizinc.org/challenge/2019
              </Link>
              <br />
              <Link href="http://www.minizinc.org/challenge/2019/rules">
                www.minizinc.org/challenge/2019/rules
              </Link>
              <br />
            </p>
            <p></p>
