      ...
      <main>
        <Container>
          <article className="prose prose-minizinc max-w-none py-6">
            <Scripts
              scripts={[
                '/challenge/2019/locations.js',
                '/challenge/2019/results.js',
                '/challenge/2019/plots.js',
                '/challenge/2019/score.js',
            ...
            <p>The results for the MiniZinc Challenge 2019 are</p>
            <Medals medals={medals[2019]} />
            ...
            zipped tar-ball <Link href="mznc2019-probs.tar.gz">here</Link>.{' '}
            ...
            <div id="footer">
              {' '}
              ©<Link href="http://data61.csiro.au">Data61, CSIRO</Link>, 2019{' '}
            </div>
          </article>
        </Container>
      </main>
