...
export default function Page() {
  return (
    <>
      <Head>
        <title>MiniZinc - Challenge 2019 Rules</title>
      </Head>
      <Header />
      <main>
        <Container>
          <article className="prose prose-minizinc max-w-none py-6">
            <h2>MiniZinc Challenge 2019 - Rules</h2>
            <Breadcrumbs
              className="not-prose"
              items={[
            ...
            <p>
              ...
              Version 2.3.1. <br /> These rules were last updated on 15 July
              2019.
            </p>
            <h3>Entrants</h3>
            <p>
              The MiniZinc Challenge 2019 will test solvers on problems written
              in MiniZinc 2.3.1.
            ...
            <p>
              ...
              Challenge 2019 image provided by the organizers. <br /> Constraint
              ...
              <li>
                <p>
                  ...
                  <Link href="/challenge/2019">
                    MiniZinc Challenge 2019 website
                  </Link>
                  .
                </p>
              </li>
            ...
            <p>
              ...
              <Link href="https://cp2019.a4cp.org">CP2019</Link>. Entrants are
              encouraged to physically attend CP2019, but are not required to in
            ...
            <li>
              ...
              <p>
                ...
                <Link href="/challenge/2019/docker">here</Link>.
              </p>
              <p>
                ...
                <li>
                  <ul>
                    <li>
                      ...
                      FlatZinc version 2.3.1. <br /> This executable will be
                    ...
                    <li>
                      ...
                      names of a MiniZinc 2.3.1 model and data file,
            ...
            <p>
              ...
              <Link href="/doc-2.3.1/en/MiniZinc Handbook.pdf">
                MiniZinc 2.3.1
              </Link>
            ...
            <ol>
              ...
              <li>
                ...
                the{' '}
                <Link href="/doc-2.3.1/en/fzn-spec.html#search-annotations">
            ...
            <p>
              ...
              <Link href="/doc-2.3.1/en/fzn-spec.html#output">
                FlatZinc 1.6 specification
              </Link>
            ...
            <p>
              During the MiniZinc Challenge 2019 all instances of Docker images
            ...
            <p>
              The benchmarks for MiniZinc Challenge 2019 (as well as for the
            ...
            <p>
              ...
              MiniZinc 2.3.1 models, making use of only the global constraints
              included in the MiniZinc 2.3.1 library, as well as some
            ...
            <p>
              Return to the{' '}
              <Link href="/challenge/2019">MiniZinc Challenge 2019</Link> home
              page.
            </p>
          </article>
        </Container>
