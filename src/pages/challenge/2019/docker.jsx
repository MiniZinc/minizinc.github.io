...
export default function Page() {
  return (
    <>
      <Head>
        <title>MiniZinc - Challenge 2019 Docker Image Preparation</title>
      </Head>
      <Header />
      <main>
        <Container>
          <article className="prose prose-minizinc max-w-none py-6">
            ...
            <p>
              ...
              for the MiniZinc Challenge 2019.
            </p>
            <p>
            ...
            <pre>
              <code>docker run -it --rm minizinc/mznc2019:1.0 /bin/bash</code>
            </pre>
            ...
            <p>
              ...
              statement must be <code>FROM minizinc/mznc2019:1.0</code>.
            </p>
            <pre>
            ...
            <ol style={{ listStyleType: 'decimal' }}>
              <li>
                ...
                <pre>
                  <code>
                    docker run -it --name solver minizinc/mznc2019:1.0 /bin/bash
                  </code>
                </pre>
                <p>
