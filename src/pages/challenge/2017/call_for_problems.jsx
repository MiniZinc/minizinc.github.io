...
export default function Page() {
  return (
    <>
      <Head>
        <title>MiniZinc - Challenge 2017 Call for Problems</title>
      </Head>
      <Header />
      <main>
        <Container>
          <article className="prose prose-minizinc max-w-none py-6">
            {' '}
            <h2>Call for Problem Submission for the MiniZinc Challenge 2017</h2>
            <Breadcrumbs
              className="not-prose"
              items={[
            ...
            <p>
              ...
              Programming. The MiniZinc Challenge 2017 is seeking interesting
            ...
            <ul>
              <li>
                Send an email with the subject line “[MZNC17] benchmark” to
            ...
            <p>
              ...
              instances are particulary welcome. Models for the 2017 challenge
            ...
            <p>
              <Link href="http://www.minizinc.org/challenge/2017">
                www.minizinc.org/challenge/2017
              </Link>
              <br />
              <Link href="http://www.minizinc.org/challenge/2017/rules">
                www.minizinc.org/challenge/2017/rules
              </Link>
              <br />
            </p>
            <p></p>
