...
export default function ResultsPage() {
  return (
    <>
      <Head>
        <title>MiniZinc - Challenge 2021 Results</title>
      </Head>
      <Header />
      <main>
        <Container>
          <article className="prose prose-minizinc max-w-none py-6">
            <Scripts
              ...
              onReady={() => init()}
            />
            <h2>MiniZinc Challenge 2021 Results</h2>

            <Breadcrumbs
              className="not-prose"
              items={[
                ['MiniZinc Challenge', '/challenge'],
                ['Challenge 2021', '/challenge/2021'],
                'Results',
              ]}
            />
            ...
            <p>The results for the MiniZinc Challenge 2021 are</p>
            <Medals medals={medals[2021]} />
            ...
            <p>The files on this page are for MiniZinc version 2.5.5.</p>
          </article>
        </Container>
      </main>
      <Footer />
