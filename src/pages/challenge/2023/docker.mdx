...
The Docker base image, which all entries must extend, was created via a [Dockerfile](/challenge/2023/dockerfiles/mznc2023/Dockerfile)
...
export default function Page({ children }) {
  return (
    <>
      <Head>
        <title>{`MiniZinc - Challenge 2023 Docker Image Praparation`}</title>
      </Head>
      <Header />
      <main>
        <Container>
