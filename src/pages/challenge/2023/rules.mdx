...
1.  Which competition CLASS(ES) the entry will compete in (see
    [below](/challenge/2023/rules#competition-classes) for details).
...
2.  A short (1-2 pages) description of the system. This
    ...
    systems.  
    System descriptions will be posted on the [MiniZinc Challenge 2023 website](/challenge/2023).
...
[assessment procedure](/challenge/2023/rules#assessment). If the entry does not conform with the rules, or
...
MiniZinc 2.7.3 library, as well as some (preferably 10 or more) instance files
...
Return to the [MiniZinc Challenge 2023](/challenge/2023) home page.

export default function Page({ children }) {
  return (
    <>
      <Head>
        <title>{`MiniZinc - Challenge 2023 Rules`}</title>
      </Head>
      <Header />
      <main>
        <Container>
