      ...
      <main>
        <Container>
          <article className="prose prose-minizinc max-w-none py-6">
            <Scripts
              scripts={[
                '/challenge/2015/locations.js',
                '/challenge/2015/results.js',
                '/challenge/2015/score.js',
              ]}
              onReady={() => init()}
            />
            ...
            <p>The results for the MiniZinc Challenge 2015 were</p>
            <Medals medals={medals[2015]} />
            ...
            <ul>
              ...
              <li>
                ...
                {/*</li><li><b>INC</b> indicates an incorrect answer </li><li><b>MZN</b> indicates that flattening aborted (time-out or out-of-memory) </li><li><b>UNK</b> indicates that no answer was returned in the time limit or the solver aborted. */}
              </li>
              <li>
                <b>UNK</b> indicates an incorrect answer <b>OR</b>
              </li>
              <li>
                <b>UNK</b> indicates that flattening aborted (time-out or
                out-of-memory) <b>OR</b>
              </li>
              <li>
            ...
            zipped tar-ball <Link href="mznc2015-probs.tar.gz">here</Link>.{' '}
