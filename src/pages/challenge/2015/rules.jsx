...
export default function Page() {
  return (
    <>
      <Head>
        <title>MiniZinc - Challenge 2015 Rules</title>
      </Head>
      <Header />
      <main>
        <Container>
          <article className="prose prose-minizinc max-w-none py-6">
            <h2>MiniZinc Challenge 2015 -- Rules</h2>
            <Breadcrumbs
              className="not-prose"
              items={[
            ...
            <p>
              ...
              Version 2.0.4. <br /> These rules were last updated on 10 July
              2015.
            </p>
            <h3>Entrants</h3>
            <p>
              The MiniZinc Challenge 2015 will test solvers on problems written
              in MiniZinc 2.0.4.
            ...
            <ol>
              ...
              <li>
                <p>
                  ...
                  <Link href="/challenge/2015">
                    MiniZinc Challenge 2015 website
                  </Link>
                  .
                </p>
              </li>
                  ...
                  <li>
                    <ul>
                      <li>
                        ...
                        handling FlatZinc version 2.0.4. If your FlatZinc solver{' '}
                        <strong>only</strong> handles XML-FlatZinc version
                        2.0.4, please contact the organizers.
                      ...
                      <li>
                        ...
                        names of a MiniZinc 2.0.4 model and data file,
            ...
            <p>
              ...
              <Link href="http://cp2015.a4cp.org">CP2015</Link>. Entrants are
              encouraged to physically attend CP2015, but are not required to in
            ...
            <p>
              During the MiniZinc Challenge 2015 all VMs will run on machines
            ...
            <p>
              The benchmarks for MiniZinc Challenge 2015 (as well as for the
            ...
            <p>
              ...
              MiniZinc 2.0.4 models, making use of only the global constraints
              included in the MiniZinc 2.0.4 library, as well as some
            ...
            <p>
              ...
              time will be included for the first time in a MiniZinc challenge.{' '}
            ...
            <p>
              Return to the{' '}
              <Link href="/challenge/2015">MiniZinc Challenge 2015</Link> home
              page.
            </p>
          </article>
        </Container>
