...
export default function Page() {
  return (
    <>
      <Head>
        <title>MiniZinc - Challenge 2011 Rules</title>
      </Head>
      <Header />
      <main>
        <Container>
          <article className="prose prose-minizinc max-w-none py-6">
            <h2>MiniZinc Challenge 2011 -- Rules</h2>
            <Breadcrumbs
              className="not-prose"
              items={[
            ...
            />
            <p>
              These are the official rules for the MiniZinc Challenge 2011.
              Version 1.0. <br /> These rules were last updated on 13 April
              2011.
            </p>
            <h3>Entrants</h3>
            <p>
              The MiniZinc Challenge 2011 will test solvers on problems written
              in MiniZinc 1.3.
            ...
            <p>
              ...
              <Link href="/challenge/2011/rules#execenv">
            ...
            <ol>
              ...
              <li>
                <p>
                  ...
                  <Link href="/challenge/2011">
                    MiniZinc Challenge 2011 website
                  </Link>
                  .
                </p>
              </li>
              <li>
                <p>
                  ...
                  solver handling FlatZinc version 1.3 or XML-FlatZinc version
                  1.3
                ...
                <p></p>
                <p>
                  The argument <i>file.fzn</i> is the name of a FlatZinc 1.3
            ...
            <p>
              The results will be announced at CP2011. Entrants are encouraged
              to physically attend CP2011, but are not required to in order to
              participate or win.
            </p>
            ...
            <p>
              During the MiniZinc Challenge 2011 all programs will run on
            ...
            <p>
              The benchmarks for MiniZinc Challenge 2011 (as well as for the
            ...
            <p>
              ...
              MiniZinc 1.3 models, making use of only the global constraints
              included in the MiniZinc 1.3 library, as well as some (preferably
            ...
            The new scoring procedure is based on the{' '}
            ...
            <p>
              Return to the{' '}
              <Link href="/challenge/2011">MiniZinc Challenge 2011</Link> home
              page.
            </p>
          </article>
        </Container>
