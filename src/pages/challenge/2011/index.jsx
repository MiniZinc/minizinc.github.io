...
export default function Page() {
  return (
    <>
      <Head>
        <title>MiniZinc - Challenge 2011</title>
      </Head>
      <Header />
      <main>
        <Container>
          <article className="prose prose-minizinc max-w-none py-6">
            <h2>MiniZinc Challenge 2011</h2>
            <Breadcrumbs
              className="not-prose"
              items={[['MiniZinc Challenge', '/challenge'], 'Challenge 2011']}
            />
            <h3>The Challenge</h3>
            <p>
            ...
            <ul>
              <li>
                <b>2011-09-12</b> The results of the MiniZinc Challenge 2011 are
                available <Link href="/challenge/2011/results">here</Link>.
              </li>
              <li>
                <b>2011-07-26</b>: the deadline for final submission has been
                moved to <strong>7 August 2011</strong>.{' '}
              </li>
              <li>
                <b>2011-06-28</b>: information about entry submission has been
                mailed to registered entrants.
                <br />
              </li>
              <li>
                <b>2011-05-20</b>: the problem submission deadline has been
                moved to <strong>10 June 2011</strong>.{' '}
              </li>
            </ul>
            <h3>Dates</h3>
            <ul>
              <li>
                Registration opens: <strong>1 May 2011</strong>.{' '}
              </li>
              <li>
              ...
              <li>
                Announcement of results at <abbr>CP2011</abbr>:{' '}
                <strong>13 September 2011</strong>.{' '}
              </li>
            </ul>
            <h3>Registration</h3>
            <p>
            ...
            <p>
              ...
              <strong>1 June 2011</strong>.
            </p>
            <h3>Rules</h3>
            <p>
              The rules for the MiniZinc Challenge 2011 are available{' '}
              <Link href="/challenge/2011/rules">here</Link>.<br /> If we need
