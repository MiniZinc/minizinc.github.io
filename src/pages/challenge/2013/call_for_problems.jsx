...
export default function Page() {
  return (
    <>
      <Head>
        <title>MiniZinc - Challenge 2013 Call for Problems</title>
      </Head>
      <Header />
      <main>
        <Container>
          <article className="prose prose-minizinc max-w-none py-6">
            {' '}
            <h2>Call for Problem Submission for the MiniZinc Challenge 2013</h2>
            <Breadcrumbs
              className="not-prose"
              items={[
            ...
            <p>
              ...
              Programming. The MiniZinc Challenge 2013 is seeking interesting
            ...
            <ul>
              <li>
                Send an email with the subject line “[MZNC13] benchmark” to
            ...
            <p>
              ...
              instances are welcome warmly. Models for the 2013 challenge can
            ...
            <p>
              <Link href="http://www.minizinc.org/challenge/2013">
                www.minizinc.org/challenge/2013
              </Link>
              <br />
              <Link href="http://www.minizinc.org/challenge/2013/rules">
                www.minizinc.org/challenge/2013/rules
              </Link>
            </p>
            <p></p>
          </article>
