...
export default function Page() {
  return (
    <>
      <Head>
        <title>MiniZinc - Challenge 2009 Rules</title>
      </Head>
      <Header />
      <main>
        <Container>
          <article className="prose prose-minizinc max-w-none py-6">
            <h2>MiniZinc Challenge 2009 -- Rules</h2>
            <Breadcrumbs
              className="not-prose"
              items={[
            ...
            <p>
              ...
              Version 1.0. <br /> These rules were last updated on 1 June 2009.
            </p>
            <h3>Entrants</h3>
            <p>
              The MiniZinc Challenge 2009 will test solvers on problems written
              in MiniZinc 1.0.
            ...
            <p>
              ...
              <Link href="/challenge/2009/rules#execenv">
            ...
            <ol>
              ...
              <li>
                <p>
                  ...
                  <Link href="/challenge/2009">
                    MiniZinc Challenge 2009 website
                  </Link>
                  .
                </p>
              </li>
              <li>
                <p>
                  ...
                  solver handling FlatZinc version 1.0 or XML-FlatZinc version
                  1.0
                ...
                <p></p>
                <p>
                  The argument <i>file.fzn</i> is the name of a FlatZinc 1.0
                ...
                The solver may in addition support the following command line
                option if it wishes to be considered in the Parallel search
                exhibition class:{' '}
                <ol>
                  <li>
                    <i>--parallel</i>
            ...
            <p>
              The results will be announced at CP2009. Entrants are encouraged
              to physically attend CP2009, but are not required to in order to
              participate or win.
            </p>
            ...
            <p>There will also be an exhibition CLASS:</p>
            <ul>
              <li>
                <dfn>Parallel search</dfn>: solvers in this class are free to
                use multiple threads or cores to solve the problem.{' '}
              </li>
            </ul>
            <p>
              The exhibition class is for demonstration only; it does not count
              towards an entry&apos;s final result.
            </p>
            <p>
            ...
            <p>
              During the MiniZinc Challenge 2009 all programs will run on
            ...
            <ul>
              ...
              <li>C compilers: gcc 3.4, 4.1, Java 1.5 </li>
            ...
            <p>
              The benchmarks for MiniZinc Challenge 2009 (as well as for the
            ...
            <p>
              ...
              MiniZinc 1.0 models, making use of only the global constraints
              included in the MiniZinc 1.0 library, as well as some (preferably
            ...
            <p>
              Return to the{' '}
              <Link href="/challenge/2009">MiniZinc Challenge 2009</Link> home
              page.
            </p>
          </article>
        </Container>
