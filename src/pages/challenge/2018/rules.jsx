...
export default function Page() {
  return (
    <>
      <Head>
        <title>MiniZinc - Challenge 2018 Rules</title>
      </Head>
      <Header />
      <main>
        <Container>
          <article className="prose prose-minizinc max-w-none py-6">
            ...
            <p>
              ...
              Version 2.1.7. <br /> These rules were last updated on 8 March
              2018.
            </p>
            <h3>Entrants</h3>
            <p>
              The MiniZinc Challenge 2018 will test solvers on problems written
              in MiniZinc 2.1.7.
            ...
            <p>
              ...
              Challenge 2018 image provided by the organizers. <br /> Constraint
              solvers that have several variants, for example that can
              alternatively use copying or trailing, may submit one entry per
              variant although the organizers reserve the right to reject such
              variations if they not sufficiently interesting, (e.g. multiple
              copies of the same solver with differing parameters).
            </p>
            <p>
            ...
            <ol>
              ...
              <li>
                <p>
                  ...
                  <Link href="/challenge/2018">
                    MiniZinc Challenge 2018 website
                  </Link>
                  .
                </p>
              </li>
            ...
            <p>
              ...
              <Link href="http://cp2018.a4cp.org">CP2018</Link>. Entrants are
              encouraged to physically attend CP2018, but are not required to in
            ...
            <li>
              ...
              <h3>Docker Images</h3> More details about Docker images and how to
              create a Docker image with your solver is available{' '}
              <Link href="/challenge/2018/docker">here</Link>.{' '}
              <p>
                ...
                <li>
                  <ul>
                    <li>
                      ...
                      FlatZinc version 2.1.7. If your FlatZinc solver{' '}
                      <strong>only</strong> handles XML-FlatZinc version 2.1.7,
                    ...
                    <li>
                      ...
                      names of a MiniZinc 2.1.7 model and data file,
            ...
            <p>
              During the MiniZinc Challenge 2018 all instances of Docker images
              will run on Amazon EC2 M5 Instance from the Amazon Web Services
              with the following specification:
            </p>
            <ul>
              {/*<li>Host Operating System for FD, FREE category: Ubuntu 16.04.2 LTS (xenial xerus)*/}
              <li>
            ...
            <p>
              The benchmarks for MiniZinc Challenge 2018 (as well as for the
            ...
            <p>
              ...
              MiniZinc 2.1.7 models, making use of only the global constraints
              included in the MiniZinc 2.1.7 library, as well as some
            ...
            <p>
              Return to the{' '}
              <Link href="/challenge/2018">MiniZinc Challenge 2018</Link> home
              page.
            </p>
          </article>
        </Container>
