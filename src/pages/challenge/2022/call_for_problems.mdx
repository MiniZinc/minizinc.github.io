...
[www.minizinc.org/challenge/2022](/challenge/2022)  
[www.minizinc.org/challenge/2022/rules](/challenge/2022/rules)

export default function Page({ children }) {
  return (
    <>
      <Head>
        <title>{`MiniZinc - Challenge 2022 Call for Problems`}</title>
      </Head>
      <Header />
      <main>
        <Container>
