...
The Docker base image, which all entries must extend, was created via a [Dockerfile](/challenge/2022/dockerfiles/mznc2022/Dockerfile)
...
export default function Page({ children }) {
  return (
    <>
      <Head>
        <title>{`MiniZinc - Challenge 2022 Docker Image Praparation`}</title>
      </Head>
      <Header />
      <main>
        <Container>
