...
<Breadcrumbs
  className="not-prose"
  items={[['MiniZinc Challenge', '/challenge'], 'Challenge 2022']}
/>
...
- **2022-08-04** Announcements of the results are [here](/challenge/2022/results).
...
- **2022-03-10** Official [Call for Problems](/challenge/2022/call_for_problems) for the MiniZinc Challenge.
...
Please carefully read [the rules](/challenge/2022/rules) before submission.
...
submission is available [here](/challenge/2022/call_for_problems). Please feel free to distribute it.

### Rules

The rules for the MiniZinc Challenge 2022 are available [here](/challenge/2022/rules).  
...
The [MiniZinc 2.6.3 Distribution](/doc-2.6.3/en) includes a MiniZinc-to-FlatZinc
converter and a large suite of MiniZinc examples and benchmarks.

The [MiniZinc Challenge](/challenge) webpage, includes the results from each
MiniZinc Challenge.
...
export default function Page({ children }) {
  return (
    <>
      <Head>
        <title>{`MiniZinc - Challenge 2022`}</title>
      </Head>
      <Header />
      <main>
        <Container>
