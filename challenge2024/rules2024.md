---
layout: default
title: MiniZinc Challenge 2024 - Rules
---

## MiniZinc Challenge 2024 - Rules

These are the official rules for the MiniZinc Challenge 2024. Version 1.0.  
These rules were last updated on 12 February 2024.

### Solver Submission

The MiniZinc Challenge 2024 will test solvers on problems written in MiniZinc 2.8.3.
...
Challenge 2024 image (as provided by the organisers) as its base.  
...
1.  Which competition CLASS(ES) the entry will compete in (see 
    [below](rules2024.html#competition-classes) for details).
...
2.  A short (1-2 pages) description of the system. This
    ...
    systems.  
    System descriptions will be posted on the [MiniZinc Challenge 2024 website](challenge.html).
...
[assessment procedure](rules2024.html#assessment). If the entry does not conform with the rules, or 
...
The results will be announced at [CP2024](https://cp2024.a4cp.org). Participants are encouraged to
attend CP2024, but are not required to in order to enter or win.
...
A challenge entry Docker image must use the MiniZinc Challenge 2024 image (as provided by the
...
MiniZinc solvers must support the following [options](doc-2.7.3/en/command_line.html#options)
...
During the MiniZinc Challenge 2024 all instances of Docker images will run on a compute server with
...
The benchmarks for MiniZinc Challenge 2024 will be selected by the judges to try to examine some of 
