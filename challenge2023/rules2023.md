...
These rules were last updated on 31 March 2023.

### Solver Submission

The MiniZinc Challenge 2023 will test solvers on problems written in MiniZinc 2.7.1.
...
FlatZinc solvers must accept the following [standard options](/doc-2.7.1/en/fzn-spec.html#command-line-interface-and-standard-options), and they must be included in the supported
`stdFlags` of the [solver configuration](/doc-2.7.1/en/fzn-spec.html#sec-cmdline-conffiles):
...
MiniZinc solvers must support the following [options](doc-2.7.1/en/command_line.html#options)
...
[FlatZinc 2.7.1 specification](https://www.minizinc.org/doc-2.7.1/en/fzn-spec.html#output).
...
[MiniZinc 2.7.1](../doc-2.7.1/en/MiniZinc%20Handbook.pdf).  
...
4.  Search annotations will be restricted to **bool_search**, **int_search**, **set_search** and
    ...
    *   search style
    ...
    [FlatZinc 2.7.1 specification](https://www.minizinc.org/doc-2.7.1/en/fzn-spec.html#search-annotations).
...
of only the global constraints included in the MiniZinc 2.7.1 library, as well as some (preferably 
