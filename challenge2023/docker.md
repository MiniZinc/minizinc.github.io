...
- Running `minizinc` with the default solver (i.e. without the `--solver` option) must run your
  ...
  - If you have a [solver configuration file](/doc-2.7.6/en/fzn-spec.html#solver-configuration-files)
...
The image contains a minimal installation of Ubuntu 20.04 and MiniZinc 2.7.6, which is installed in
the `/usr/local/bin` directory. It is recommended that you create a 
[Solver Configuration File](/doc-2.7.6/en/fzn-spec.html#solver-configuration-files) for your solver,
and set it as the default solver using a
[User Configuration File](/doc-2.7.6/en/command_line.html#user-configuration-files) (the details
...
#
# See https://www.minizinc.org/doc-2.7.6/en/command_line.html#user-configuration-files
...
See the documentation [here](/doc-2.7.6/en/fzn-spec.html#sec-cmdline-conffiles) for more information.
